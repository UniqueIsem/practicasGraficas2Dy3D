...
public class Escalamiento_4 {
    ...
    public void dibujarCubo(Color color, double factorEscala) {
        ...
        for (int[] arista : aristas) {
            int[] p1 = proyectar(rotar(scale(translate(vertices[arista[0]], traslacionX, traslacionY, traslacionZ), factorEscala), posArista, posArista, posArista), xc, yc, zc);
            int[] p2 = proyectar(rotar(scale(translate(vertices[arista[1]], traslacionX, traslacionY, traslacionZ), factorEscala), posArista, posArista, posArista), xc, yc, zc);
    ...
    private void initComponents() {
        ...
        frame.addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch (key) {
                    case KeyEvent.VK_Q -> {
                        traslacionX -= 10; // Decrementar la traslación en el eje X
                        System.out.println("traslacionX " + traslacionX);
                    }
                    case KeyEvent.VK_D -> {
                        traslacionX += 10; // Incrementar la traslación en el eje X
                        System.out.println("traslacionX " + traslacionX);
                    }
                    case KeyEvent.VK_W -> {
                        traslacionY -= 10; // Decrementar la traslación en el eje Y
                        System.out.println("traslacionY " + traslacionY);
                    }
                    case KeyEvent.VK_S -> {
                        traslacionY += 10; // Incrementar la traslación en el eje Y
                        System.out.println("traslacionY " + traslacionY);
                    }
                    case KeyEvent.VK_A -> {
                        traslacionZ -= 10; // Decrementar la traslación en el eje Z
                        System.out.println("traslacionZ " + traslacionZ);
                    }
                    case KeyEvent.VK_E -> {
                        traslacionZ += 10; // Incrementar la traslación en el eje Z
                        System.out.println("traslacionZ " + traslacionZ);
                    }
                    case KeyEvent.VK_Z -> {
                        factorEscala *= 0.9;
