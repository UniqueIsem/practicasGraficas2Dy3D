...
public class Traslacion_3 extends JFrame {
    ...
    public void dibujarCubo(Color color) {
        ...
        for (int[] arista : aristas) {
            int[] p1 = proyectar(rotar(translate(vertices[arista[0]], traslacionX, traslacionY, traslacionZ), posArista, posArista, posArista), xc, yc, zc);
            int[] p2 = proyectar(rotar(translate(vertices[arista[1]], traslacionX, traslacionY, traslacionZ), posArista, posArista, posArista), xc, yc, zc);
